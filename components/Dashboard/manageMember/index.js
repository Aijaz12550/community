...
import { getMembers } from "$middleware";
      ...
      tableCreate: [
        {
          ...
          email: "alice.bryant@example.com",
          phoneNo: "207 555-0119",
          hasResident: false,
          hasDeative: false,
        },
  ...
  render () {
    ...
    return (
      <div className="content manage-member-component">
        ...
        <Row
          className="add-row-alert"
          style={
            this.state.hasAddRow ? { display: "flex" } : { display: "none" }
          }
        >
          <Col>
