...
export default class ManageDocument extends Component {
  ...
  componentDidMount() {
    ...
    dispatch(documentType(`bearer ${access_token}`));
  }
  ...
  deleteRow = (val, rowIndex) => {
    ...
    dispatch(deleteDocument(deleteRowObj));
  };
